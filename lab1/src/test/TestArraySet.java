...
public class TestArraySet {
	...
	public final void testAddAll() {
		ArraySet<Integer> trololol = new ArraySet<Integer>();
		for (int i = 0; i < 10; i++) {
			trololol.add(i);
		}
		...
		assertTrue("addAll() returns wrong boolean-value", s.addAll(trololol));
		assertFalse("addAll() adds duplicates", s.addAll(test));
